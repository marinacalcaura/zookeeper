...
public class CreateDataTreeTest {
    ...
    public static Collection<Object[]> parameters() {
        return Arrays.asList(new Object[][] {
                ...
                //{TestType.CREATE_VALID_PATH,null, new byte[2], ZooDefs.Ids.CREATOR_ALL_ACL, 0, 1, 1, 1},
                ...
                //agg alla seconda iterazione
                //nodo TTL con path valido
                {TestType.CREATE_VALID_PATH,"/a", new byte[2], ZooDefs.Ids.CREATOR_ALL_ACL, 0xFF00000000000111L, 0,0,1},
                //nodo Container con path valido
                {TestType.CREATE_VALID_PATH,"/a", new byte[2], ZooDefs.Ids.CREATOR_ALL_ACL, 0x8000000000000000L, 0,0,1},
